...
module.exports = {
  entry: {
    ...
    captcheck: {
      import: ["./apps/captcha/assets/captcheck.js"],
    ...
    category_formset: {
      import: ["adhocracy4/adhocracy4/categories/assets/category_formset.js"],
      dependOn: "adhocracy4",
    },
    image_uploader: {
    ...
    poll_management: {
      import: ["adhocracy4/adhocracy4/polls/static/react_poll_management.jsx"],
      dependOn: "adhocracy4",
    },
    polls: {
      import: ["adhocracy4/adhocracy4/polls/static/react_polls.jsx"],
      dependOn: "adhocracy4",
    },
    arpas: {
      import: ["./apps/arpas/assets/react_arpas.jsx"],
      dependOn: "adhocracy4",
    },
  ...
  resolve: {
    ...
    modules: [path.resolve("./node_modules")].concat(
