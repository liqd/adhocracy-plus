...
def test_pre_phase(phase_factory, proposal_factory, user, member_factory, admin):
...
@pytest.mark.django_db
def test_phase_active(phase_factory, proposal_factory, user, member_factory, admin):
    phase, _, project, item = setup_phase(
        phase_factory, proposal_factory, phases.RequestPhase
    )
    anonymous, moderator, initiator = setup_users(project)
...
def test_phase_active_project_draft(
    phase_factory, proposal_factory, user, member_factory, admin
):
    phase, _, project, item = setup_phase(
        phase_factory,
        proposal_factory,
