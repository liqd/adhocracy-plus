...
perm_name = "a4_candy_budgeting.comment_proposal"
...
def test_phase_active_project_private(
    phase_factory, user, user2, member_factory, proposal_factory
):
    phase, _, project, item = setup_phase(
        phase_factory,
        proposal_factory,
...
def test_phase_active_project_draft(
    phase_factory, proposal_factory, user, member_factory
):
    phase, _, project, item = setup_phase(
        phase_factory,
        proposal_factory,
