...
def test_create_view(
    ...
    with freeze_phase(phase):
        ...
        assert_template_response(response, "a4_candy_mapideas/mapidea_create_form.html")
...
@pytest.mark.django_db
def test_user_can_create_mapidea_during_active_phase(
...
@pytest.mark.django_db
def test_admin_can_create_mapidea_in_wrong_phase(
