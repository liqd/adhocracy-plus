...
perm_name = "a4_candy_documents.comment_paragraph"
...
def test_pre_phase(
    phase_factory, chapter_factory, paragraph_factory, user, member_factory
):
...
def test_phase_active_project_private(
    phase_factory, chapter_factory, paragraph_factory, user, user2, member_factory
):
    phase, _, project, item = setup_phase(
        phase_factory,
        chapter_factory,
