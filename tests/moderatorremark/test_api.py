...
@pytest.mark.django_db
def test_normal_user_can_not_edit_remark(apiclient,
                                         user,
...
@pytest.mark.django_db
def test_moderator_can_edit_remark(apiclient,
                                   user,
                                   moderator_remark_factory):
    remark = moderator_remark_factory()
    assert ModeratorRemark.objects.all().count() == 1
...
@pytest.mark.django_db
def test_initiator_can_edit_remark(apiclient,
                                   user,
                                   moderator_remark_factory):
    remark = moderator_remark_factory()
    assert ModeratorRemark.objects.all().count() == 1
