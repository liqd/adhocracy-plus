...
@pytest.mark.django_db
def test_admin_can_create_subject(client, phase_factory, category_factory, admin):
    phase = phase_factory(phase_content=phases.DebatePhase())
    module = phase.module
    url = reverse(
        "a4dashboard:subject-create",
    ...
    with freeze_phase(phase):
        ...
        response = client.get(url)
        assert_template_response(response, "a4_candy_debate/subject_create_form.html")
