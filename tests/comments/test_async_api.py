...
@pytest.mark.django_db
def test_creater_of_comment_can_set_removed_flag(apiclient, comment_factory,
...
@pytest.mark.django_db
def test_moderator_of_comment_can_set_censored_flag(apiclient,
                                                    comment_factory,
                                                    idea_factory,
                                                    phase_factory):

    phase, _, project, idea = setup_phase(
        phase_factory, idea_factory, RatingPhase
    )
    _, moderator, _ = setup_users(project)
    comment = comment_factory(content_object=idea)
