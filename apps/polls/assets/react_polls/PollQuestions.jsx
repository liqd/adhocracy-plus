...
import { PollChoice } from 'adhocracy4/adhocracy4/polls/static/PollDetail/PollChoice'
import { PollOpenQuestion } from 'adhocracy4/adhocracy4/polls/static/PollDetail/PollOpenQuestion'
import PollResults from 'adhocracy4/adhocracy4/polls/static/PollDetail/PollResults'
...
class PollQuestions extends React.Component {
  ...
  render () {
    ...
    const showProsopoCaptcha = Boolean(
