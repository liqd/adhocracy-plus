        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="The description will be displayed on the landing page. max. 400 characters",
                        max_length=400,
                ...
                (
                    ...
                    adhocracy4.images.fields.ConfiguredImageField(
                        "logo",
                        blank=True,
                        help_text="The Logo representing your organisation. The image must be square and it should be min. 200 pixels wide and 200 pixels tall. Allowed file formats are png, jpeg, gif. The file size should be max. 5 MB.",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="For supporting organisations, the banner asking for donations is not displayed on their pages.",
                        verbose_name="is a supporting organisation",
                    ),
                ),
                (
                    "initiators",
