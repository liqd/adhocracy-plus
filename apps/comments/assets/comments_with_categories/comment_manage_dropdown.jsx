      ...
      <li className="dropdown">
        ...
        <ul className="dropdown-menu dropdown-menu-right">
          {(props.renderOwnerOptions || props.renderModeratorOptions) && [
            ...
            <li key="3">
              <a className="dropdown-item btn btn--sm btn-link" href={`#comment_delete_${props.id}`} data-toggle="modal">{django.gettext('Delete')}</a>
            </li>,
            <li className="divider" key="4" />
          ]}
          {props.renderModeratorOptions && props.isParentComment && [
            <li key="5">
              <a className="dropdown-item btn btn--sm btn-link" href={`#comment_moderate_${props.id}`} data-toggle="modal">{django.gettext('Recommend')}</a>
            </li>,
