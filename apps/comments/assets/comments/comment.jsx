          ...
          <div className="container">
            ...
            <div className="comment-box row">
              <div className="comment-box_left pr-0 pr-md-3">
                ...
                <a href={`./?comment=${this.props.id}`} id={`comment_${this.props.id}`} className="comment-submission-date comment-anchor">{lastDate}</a>
                {moderatorLabel}
              </div>
            ...
            {this.state.displayNotification &&
              <div className="comment-success-notification"><i className="icon-check" aria-hidden="true" /> {successMessage}</div>}
          </div>
        </div>
        <div className="container">
