      ...
      <div>
        <div className="comment-box">
          ...
          <div className={(this.state.comments.length === 0 && this.state.loading) ? 'hidden' : 'comments_nav_parent'}>
            <nav className={this.state.showSearch === 0 ? 'hidden' : 'bg-faded comments_nav'}>
              <div className="container">
                <div className="row px-sm-3">
                  <div className={this.state.search !== '' ? 'comments_nav__text comments_nav__text--wide' : 'hidden'}>
                  ...
                  <div className="comments_nav__search pr-1 pl-md-3 px-sm-2 mx-3 mx-sm-0">
                  ...
                  <div className="comments_nav__dropdown pr-sm-0">
                    <div className="dropdown">
                      <button
                        className="btn btn--transparent dropdown-toggle btn--border px-sm-2 mt-2 mt-sm-0 comments_nav__btn" type="button"
                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                      >
                        <span className={this.state.sort === 'new' ? 'comments_nav__btn-text btn--upper' : 'hidden'}>{django.gettext('sorted by: ')}{sorts[this.state.sort]}</span>
                        <span className={this.state.sort !== 'new' ? 'comments_nav__btn-text small-screen btn--capitalize' : 'hidden'}>{sorts[this.state.sort]}</span>
                        <i className={this.state.sort === 'new' ? 'icon-arrow_dropdown comments_nav__btn-icon' : 'icon-check comments_nav__btn-icon'} aria-hidden="true" />
                      </button>
