...
urlpatterns = [
    re_path(r'^projects/(?P<project_slug>[-\w_]+)/blueprints/$',
    ...
    re_path(r'^projects/(?P<project_slug>[-\w_]+)/blueprints/'
            ...
            name='module-create'),
    re_path(r'^publish/module/(?P<module_slug>[-\w_]+)/$',
...
urlpatterns += [
    path('organisations/projects/create',
         views.ProjectCreateView.as_view(),
         name='project-create'),
    path('organisations/projects/',
         a4dashborad_views.ProjectListView.as_view(),
         name='project-list'),
    re_path(r'^projects/(?P<project_slug>[-\w_]+)/$',
            a4dashborad_views.ProjectUpdateView.as_view(),
            name='project-edit'),
    re_path(r'^publish/project/(?P<project_slug>[-\w_]+)/$',
