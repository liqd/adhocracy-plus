...
class UseCaseBlock(blocks.StructBlock):
    ...
    use_cases = blocks.ListBlock(
        blocks.PageChooserBlock(target_model="a4_candy_cms_use_cases.UseCasePage")
    )
...
class ExampleBlock(blocks.StructBlock):
    examples = blocks.ListBlock(CallToActionBlock(label="CTA Column"))
