...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='address',
            field=wagtail.core.fields.RichTextField(help_text='The address is published on the contact form.'),
        ),
        migrations.AlterField(
            model_name='organisationsettings',
            name='contacts',
            field=wagtail.core.fields.RichTextField(help_text='The contacts are published on the contact form.'),
        ),
        migrations.AlterField(
            model_name='organisationsettings',
            name='platform_name',
