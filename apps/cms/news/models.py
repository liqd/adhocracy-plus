...
class NewsPage(Page):
    ...
    title_de = models.CharField(max_length=250, blank=True, verbose_name="Title")
    title_en = models.CharField(max_length=250, blank=True, verbose_name="Title")
    ...
    author = models.CharField(max_length=255, blank=True, verbose_name="Author Name")
