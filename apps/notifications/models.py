...
# Field mapping
CATEGORY_TO_FIELDS = {
    NotificationCategory.PROJECT_UPDATES: (
        "email_project_updates",
        "notify_project_updates",
    ),
    NotificationCategory.PROJECT_EVENTS: (
        "email_project_events",
        "notify_project_events",
    ),
    NotificationCategory.USER_ENGAGEMENT: (
...
class NotificationSettings(models.Model):
    ...
    notify_project_updates = models.BooleanField(
        default=True, verbose_name=_("In-app project updates")
    )

    # Project related - Project events
    email_project_events = models.BooleanField(
        default=True, verbose_name=_("Email project events")
    )
    notify_project_events = models.BooleanField(
        default=True, verbose_name=_("In-app project events")
    )

    # User interactions
    email_user_engagement = models.BooleanField(
        default=True, verbose_name=_("Email user interactions")
    )
    notify_user_engagement = models.BooleanField(
        default=True, verbose_name=_("In-app user interactions")
    )

    email_messages = models.BooleanField(default=True, verbose_name=_("Email messages"))
    notify_messages = models.BooleanField(
        default=True, verbose_name=_("In-app messages")
    )

    email_invitations = models.BooleanField(
        default=True, verbose_name=_("Email invitations")
    )
    notify_invitations = models.BooleanField(
        default=True, verbose_name=_("In-app invitations")
    )

    email_moderation = models.BooleanField(
        default=True, verbose_name=_("Email moderation actions")
    )
    notify_moderation = models.BooleanField(
        default=True, verbose_name=_("In-app moderation actions")
    )

    email_warnings = models.BooleanField(default=True, verbose_name=_("Email warnings"))
    notify_warnings = models.BooleanField(
        default=True, verbose_name=_("In-app warnings")
    )
